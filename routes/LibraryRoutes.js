...
const { createLibrary, booksget, getLib, addLibBooks, updateDate, addToLibrary, removeFromLibrary, getLibAndStudentDetailsOnScan } = require("../controllers/libraryController");
...
router.route("/getDataOnScan").get(getLibAndStudentDetailsOnScan);
